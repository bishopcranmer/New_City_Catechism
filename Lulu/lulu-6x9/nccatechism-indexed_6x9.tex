...
\makeindex[columns=4,name=gen,title=Genesis]
\makeindex[columns=4,name=exo,title=Exodus]
\makeindex[columns=4,name=lev,title=Leviticus]
\makeindex[columns=4,name=num,title=Numbers]
\makeindex[columns=4,name=deu,title=Deuteronomy]
\makeindex[columns=4,name=jos,title=Joshua]
\makeindex[columns=4,name=jdg,title=Judges]
\makeindex[columns=4,name=rut,title=Ruth]
\makeindex[columns=4,name=1sa,title=1 Samuel]
\makeindex[columns=4,name=2sa,title=2 Samuel]
\makeindex[columns=4,name=1ki,title=1 Kings]
\makeindex[columns=4,name=2ki,title=2 Kings]
\makeindex[columns=4,name=1ch,title=1 Chronicles]
\makeindex[columns=4,name=2ch,title=2 Chronicles]
\makeindex[columns=4,name=ezr,title=Ezra]
\makeindex[columns=4,name=neh,title=Nehemiah]
\makeindex[columns=4,name=est,title=Esther]
\makeindex[columns=4,name=job,title=Job]
\makeindex[columns=4,name=psa,title=Psalms]
\makeindex[columns=4,name=pro,title=Proverbs]
\makeindex[columns=4,name=ecc,title=Ecclesiastes]
\makeindex[columns=4,name=son,title=Song of Solomon]
\makeindex[columns=4,name=isa,title=Isaiah]
\makeindex[columns=4,name=jer,title=Jeremiah]
\makeindex[columns=4,name=lam,title=Lamentations]
\makeindex[columns=4,name=eze,title=Ezekiel]
\makeindex[columns=4,name=dan,title=Daniel]
\makeindex[columns=4,name=hos,title=Hosea]
\makeindex[columns=4,name=joe,title=Joel]
\makeindex[columns=4,name=amo,title=Amos]
\makeindex[columns=4,name=oba,title=Obadiah]
\makeindex[columns=4,name=jon,title=Jonah]
\makeindex[columns=4,name=mic,title=Micah]
\makeindex[columns=4,name=nah,title=Nahum]
\makeindex[columns=4,name=hab,title=Habakkuk]
\makeindex[columns=4,name=zep,title=Zephaniah]
\makeindex[columns=4,name=hag,title=Haggai]
\makeindex[columns=4,name=zec,title=Zechariah]
\makeindex[columns=4,name=mal,title=Malachi]
\makeindex[columns=4,name=mat,title=Matthew]
\makeindex[columns=4,name=mar,title=Mark]
\makeindex[columns=4,name=luk,title=Luke]
\makeindex[columns=4,name=joh,title=John]
\makeindex[columns=4,name=act,title=Acts]
\makeindex[columns=4,name=rom,title=Romans]
\makeindex[columns=4,name=1co,title=1 Corinthians]
\makeindex[columns=4,name=2co,title=2 Corinthians]
\makeindex[columns=4,name=gal,title=Galatians]
\makeindex[columns=4,name=eph,title=Ephesians]
\makeindex[columns=4,name=phi,title=Philippians]
\makeindex[columns=4,name=col,title=Colossians]
\makeindex[columns=4,name=1th,title=1 Thessalonians]
\makeindex[columns=4,name=2th,title=2 Thessalonians]
\makeindex[columns=4,name=1ti,title=1 Timothy]
\makeindex[columns=4,name=2ti,title=2 Timothy]
\makeindex[columns=4,name=tit,title=Titus]
\makeindex[columns=4,name=phm,title=Philemon]
\makeindex[columns=4,name=heb,title=Hebrews]
\makeindex[columns=4,name=jam,title=James]
\makeindex[columns=4,name=1pe,title=1 Peter]
\makeindex[columns=4,name=2pe,title=2 Peter]
\makeindex[columns=4,name=1jo,title=1 John]
\makeindex[columns=4,name=2jo,title=2 John]
\makeindex[columns=4,name=3jo,title=3 John]
\makeindex[columns=4,name=jud,title=Jude]
\makeindex[columns=4,name=rev,title=Revelation]
...
\settypeblocksize{6.92in}{4.62in}{*}
\setulmargins{*}{*}{1.618}
\setlrmargins{*}{*}{1.618}
